    ...
    <div className="min-h-screen bg-[#080c16] text-slate-100 flex flex-col">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 flex-1 w-full space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          {/* Daily Challenge */}
          <div className="md:col-span-2 p-6 rounded-2xl bg-gradient-to-r from-amber-950/40 via-orange-950/20 to-slate-900 border border-amber-500/30 shadow-xl relative overflow-hidden flex flex-col justify-between">
            ...
            <div>
              <div className="flex items-center space-x-2 text-amber-400 text-xs font-mono font-semibold mb-2">
          ...
          <div className="p-6 rounded-2xl bg-slate-900/80 border border-slate-800 shadow-xl flex flex-col justify-between">
            <div className="space-y-3">
              ...
              <div className="flex items-baseline space-x-2">
                ...
                <span className="text-xs text-orange-400 font-semibold uppercase">Days Active</span>
              </div>
              <p className="text-[11px] text-slate-400">
                Longest recorded streak: <strong className="text-slate-200">{userProgress?.longestStreak ?? 0} days</strong>. Practice daily to keep your flame blazing!
              </p>
            </div>

            {/* Streak mini week dots */}
            <div className="grid grid-cols-7 gap-1.5 pt-4 border-t border-slate-800/80 text-center font-mono text-[10px]">
                  ...
                  <div key={i} className="flex flex-col items-center space-y-1">
                    ...
                    <span
                      className={`w-4 h-4 rounded-full flex items-center justify-center ${
                        active
                          ? 'bg-orange-500 text-slate-950 font-bold shadow-sm shadow-orange-500/50'
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-5">
          ...
          <div className="p-5 rounded-2xl bg-[#0d1220] border border-slate-800/90 shadow-lg space-y-4">
            <div className="flex items-center justify-between">
              <span className="text-xs font-mono text-slate-400">SOLVED PROBLEMS</span>
              <Award className="w-4 h-4 text-indigo-400" />
            </div>

            <div className="flex items-baseline justify-between">
              <div>
                <span className="text-3xl font-extrabold text-white font-mono">{solvedCount}</span>
                <span className="text-xs text-slate-500 font-mono"> / {totalProblems}</span>
              </div>
              <span className="text-xs font-mono text-indigo-400 font-bold">{overallPercent}%</span>
            </div>
          ...
          <div className="p-5 rounded-2xl bg-[#0d1220] border border-slate-800/90 shadow-lg space-y-4">
            ...
            <div className="flex items-baseline justify-between">
              <div>
                <span className="text-3xl font-extrabold text-white font-mono">{easySolved}</span>
          ...
          <div className="p-5 rounded-2xl bg-[#0d1220] border border-slate-800/90 shadow-lg space-y-4">
            <div className="flex items-center justify-between">
              <span className="text-xs font-mono text-amber-400">MEDIUM DIFFICULTY</span>
              <span className="w-2.5 h-2.5 rounded-full bg-amber-500" />
            </div>

            <div className="flex items-baseline justify-between">
              <div>
                <span className="text-3xl font-extrabold text-white font-mono">{medSolved}</span>
          ...
          <div className="p-5 rounded-2xl bg-[#0d1220] border border-slate-800/90 shadow-lg space-y-4">
            <div className="flex items-center justify-between">
              <span className="text-xs font-mono text-rose-400">HARD DIFFICULTY</span>
              <span className="w-2.5 h-2.5 rounded-full bg-rose-500" />
            </div>

            <div className="flex items-baseline justify-between">
              <div>
                <span className="text-3xl font-extrabold text-white font-mono">{hardSolved}</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="p-6 rounded-2xl bg-[#0d1220] border border-slate-800 shadow-xl space-y-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-2">
                <Target className="w-4 h-4 text-indigo-400" />
                <h3 className="font-semibold text-sm text-white">Topic Mastery Progression</h3>
              </div>
              <span className="text-xs text-slate-400 font-mono">{topicMasteryList.length} Topics</span>
            </div>
              ...
              {topicMasteryList.slice(0, 6).map(tm => (
                <div key={tm.topic} className="space-y-1">
                  <div className="flex items-center justify-between text-xs">
                    <span className="font-medium text-slate-200">{tm.topic}</span>
          ...
          <div className="p-6 rounded-2xl bg-[#0d1220] border border-slate-800 shadow-xl space-y-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-2">
                ...
                <h3 className="font-semibold text-sm text-white">Recent Submissions</h3>
              </div>
              <Link href="/submissions" className="text-xs text-indigo-400 hover:underline">
                View All
              </Link>
            </div>
